...
code_agent = create_agent(
    ...
    Before editing code, you may clone the codebase using clone_repo if needed in a temporary directory.
    The repository URL is provided in global variable REPO_URL.
