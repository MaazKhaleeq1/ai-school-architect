...
def navigate_repo() -> str:
    print("[CANARY] Navigating to the repository...")
    "Navigate to the cloned Git repository from the provided repo_dir."

    REPO_DIR = "/Users/maazkhaleeq/development/repos/Lithium/Lithium-FAF-Copilot"

    try:
        # Navigate to the cloned directory
        subprocess.run(["cd", REPO_DIR], capture_output=True, text=True, check=True)
...
def commit_and_create_pr(
    print("[CANARY] Creating a new branch...")
    branch_name: str,
    commit_message: str,
    pr_title: str,
